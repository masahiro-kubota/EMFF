function[F, T] = plot_magnetic_field_FT(l1, l2, x)
%磁場と電磁力をあ3D表示
...
B = magnetic_flux_three_coil(X, Y, Z, I1_x, I1_y, I1_z, a, N, p1, q1, l1);       
B_x = B(1);
B_y = B(2);
B_z = B(3);
...
[F, T] = Ampere2(I2_x, I2_y, I2_z, I1_x, I1_y, I1_z, a, N, x, y, z, p1, q1, l1, p2, q2, l2);
